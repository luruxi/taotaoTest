 ...
 */
function login() {
    return location.href = "http://localhost:5051/page/login";
}
function regist() {
    return location.href = "http://localhost:5051/page/register";
}
...
function search(a) {
    var b = "http://localhost:6061/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
